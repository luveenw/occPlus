# Install dependencies - this is already taken care of by the DESCRIPTION file,
# but you can run this to make sure everything is installed.
...
install_if_missing(c(
    "fansi", "downlit", "pkgdown", "devtools", "roxygen2", "usethis"
))
...
# (WIP) install and build from GitHub
...
# GENERATED ON WINDOWS WON'T RUN ON MACOS, FOR EXAMPLE
#
